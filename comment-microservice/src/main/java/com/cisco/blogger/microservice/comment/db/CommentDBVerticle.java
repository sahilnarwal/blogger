package com.cisco.blogger.microservice.comment.db;
...
import com.cisco.blogger.microservice.comment.CommentTopics;
import com.cisco.blogger.microservice.comment.model.Comment;
...
public class CommentDBVerticle extends AbstractVerticle {
	...
	public CommentDBVerticle() {
		MongoClient mongo = new MongoClient("10.128.0.4", 27017);
