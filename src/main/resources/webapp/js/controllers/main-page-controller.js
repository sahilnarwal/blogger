(function() {
	...
	.controller('MainPageController', ['BlogService',  '$location' , '$scope', 'blogsList','favBlogsList', function (BlogService, $location, $scope, blogsList,favBlogsList) {
		console.log('blogsList : ' + blogsList);
		//var tempbloglist = blogsList;
		$scope.blogs = blogsList;
		$scope.favBlogs=favBlogsList;
		console.log('favBlogs : ' + favBlogsList);
		/*var i = 0;
