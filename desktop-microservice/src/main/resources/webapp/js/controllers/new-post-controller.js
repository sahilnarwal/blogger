        ...
        function createPost() {
            ...
            if (npc.authenticated) {
               ...
               // npc.blog.blogLikes = 0;
                ...
                npc.blog.author = npc.user.username/*{"name" : npc.user.userInfo.name,"email" : npc.user.email,"avatarImgSrc" : npc.user.userInfo.avatarImgSrc};*/
